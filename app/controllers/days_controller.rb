class DaysController < ApplicationController
  ...
  private
    ...
    def day_params
      params.require(:day).permit(:bleeding, :sensation, :characteristics, :cervix, :temp, :number, :date, :weight, :cramps, :irritability, :sensitivity, :drinks, :hours_sleep, :tenderness)
    end
end
